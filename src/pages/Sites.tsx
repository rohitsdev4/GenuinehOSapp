...
import { MapPin, Plus, MoreVertical, Calendar, Hammer, User } from 'lucide-react';
...
export default function Sites() {
  const { data: sites, loading, remove: removeSite, update: updateSite } = useFirestore<Site>('sites');
